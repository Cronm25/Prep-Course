...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
  ...
  // Tu código:
  var num_=objetoMisterioso.numeroMisterioso*5;
  return num_;
...
function tienePropiedad(objeto, propiedad) {
  ...
  // Tu código:
  Object.getOwnPropertyNames(objeto).forEach(function(valor) {
    if(valor==propiedad){
      return true;
    }
  });
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Devuelve la suma
  // Tu código:
  var cantidad_de_likes=0;
  usuario.posts.forEach((valor)=>{
    cantidad_de_likes=cantidad_de_likes+valor.likes;
  });
  return cantidad_de_likes;
}
